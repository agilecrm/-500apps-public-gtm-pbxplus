...

{
  ...
  "description": "PBX Plus is an advanced communications system and IVR for your business needs.\nhttps://infinity.500apps.com/Pbxplus",
  "containerContexts": [
    "WEB"
  ]
}
...
const trackingUrl='https://gtm.500apps.com/gtm/pbxplus/'+api_key+'.js';
...
Created on 11/25/2021, 10:35:06 AM
